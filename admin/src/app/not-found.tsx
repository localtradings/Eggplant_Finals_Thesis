  ...
  return (
    <main className="grid min-h-screen place-items-center p-5">
      <section className="surface max-w-md p-8 text-center">
        <p className="font-mono text-sm font-bold text-[#1f6b3a]">404</p>
        ...
        <Link href="/overview" className="focus-ring mt-5 inline-flex h-11 items-center rounded-xl bg-[#1f6b3a] px-4 font-semibold text-white">
          Return to overview
        </Link>
      </section>
    </main>
